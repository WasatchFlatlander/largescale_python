...
import logging
logging.basicConfig(level = logging.INFO, filename = LOGFILE, format = '%(levelname)s - %(message)s')

def pet_log(dict_to_log):
    logging.critical('On %s, I\'m taking my %s to %s.', dict_to_log['day'], dict_to_log['species'], dict_to_log['destination'])
